				...
				<div class="layui-row" style="display: flex;width:980px;margin: 0 auto;">
					...
					<div class="layui-col-md7" style="padding-left: 20px;flex: 1;" :style='{"padding":"0","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0 0 0 20px","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
						...
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>饮品编号：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yinpinbianhao}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>饮品种类：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yinpinzhonglei}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>饮品规格：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yinpinguige}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>饮品口味：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yinpinkouwei}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>饮品特色：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yinpintese}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>商家账号：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.shangjiazhanghao}}
							</span>
						</div>
						<div :style='{"padding":"6px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"15px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>商家姓名：</span>
							<span  :style='{"padding":"5px 10px","boxShadow":"0 0 0px rgba(110,22,64,.3)","borderColor":"rgba(209, 209, 209, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' class="desc">
                        ...
                        <button v-if="!detail.alllimittimes" style="height:auto;" :style='{"padding":"0 20px","boxShadow":"0 0 0px rgba(110,22,64,.3)","margin":"0 5px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(122, 118, 160, 1)","color":"#fff","borderRadius":"44px","borderWidth":"0","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' type="button" class="layui-btn layui-btn-warm">
                            商品无货
                        </button>
					...
					<div class="layui-tab layui-tab-card" :style='{"boxShadow":"0 0 6px rgba(98, 53, 106, 0.3)","borderColor":"rgba(98, 53, 106, 0.3)","backgroundColor":"#fff","borderRadius":"10px","borderStyle":"solid","borderWidth":"1px"}' style="overflow: hidden;">
						...
						<div style="word-break:break-all" class="layui-tab-content">
							...
							<div class="layui-tab-item layui-show">
								<div v-html="detail.yinpinjieshao"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`yinpinxinxi`);
					...
					addCartTap() {
						...
						layui.http.request('cart/list', 'get', {
							...
							layui.http.requestJson('cart/save', 'post', {
                                ...
                                picture:vue.detail.yinpintupian.split(",")[0],
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
								...
								name: this.title,
							    type:1,
								picture:vue.detail.yinpintupian,
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
					vue.title = vue.detail.yinpinmingcheng;
					// 轮播图片
					vue.swiperList = vue.detail.yinpintupian ? [http.baseurl+vue.detail.yinpintupian.split(",")[0]] : [];
					// var swiperItemHtml = '';
