...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商家电话</label>
										<input name="shangjiadianhua" id="shangjiadianhua" name="shangjiadianhua" class="form-control" placeholder="商家电话">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#shangjiadianhua").val(ruleForm.shangjiadianhua);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangjiadianhua != null && res.data.shangjiadianhua != ''){

						$("#shangjiadianhua").val(res.data.shangjiadianhua);
						$("#shangjiadianhua").attr('readonly','readonly');
					}
