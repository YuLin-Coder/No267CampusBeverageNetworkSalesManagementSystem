...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shangjiadianhua')">商家电话<i id="shangjiadianhuaIcon" class="fa fa-sort"></i></th>
											<th>头像</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shangjiadianhuaCell  = document.createElement('td');

						 shangjiadianhuaCell.innerHTML = item.shangjiadianhua;

			row.appendChild(shangjiadianhuaCell);
