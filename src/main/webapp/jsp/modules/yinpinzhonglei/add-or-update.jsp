		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑饮品种类</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑饮品种类</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">饮品种类信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>饮品种类</label>
										<input name="yinpinzhonglei" id="yinpinzhonglei" name="yinpinzhonglei" class="form-control" placeholder="饮品种类">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yinpinzhonglei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yinpinzhonglei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yinpinzhonglei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yinpinzhonglei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#yinpinzhonglei").val(ruleForm.yinpinzhonglei);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yinpinzhonglei != null && res.data.yinpinzhonglei != ''){
						...
						$("#yinpinzhonglei").val(res.data.yinpinzhonglei);
						$("#yinpinzhonglei").attr('readonly','readonly');
					}
				}
			});  
            }
